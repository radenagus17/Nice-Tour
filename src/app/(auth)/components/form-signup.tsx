...
const SubmitButton = () => {
  ...
  return (
    <button
      disabled={pending}
      type="submit"
      className="text-center text-flysha-black rounded-full bg-flysha-light-purple font-bold w-full p-[12px_30px] transition-all duration-300 hover:shadow-[0_10px_20px_0_#B88DFF] disabled:opacity-60"
    >
      Create New Account
    </button>
  );
      ...
      <div className="flex gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="rounded-full w-full p-[12px_20px] h-[48px] bg-[#EDE8F5] appearance-none outline-none font-semibold focus:ring-2 focus:ring-[#EDE8F5]"
          />
        </div>
      </div>
