...
export const formFlightSchema = z.object({
  ...
  price: z.string({ required_error: "Harga tiket pesawat tidak boleh kosong" }),
  ...
  departureCityCode: z
    ...
    .min(3, {
      message: "Kode kota keberangkatan harus memiliki minimal 3 karakter",
    })
    .max(3, {
      message: "Kode kota keberangkatan harus memiliki maximal 3 karakter",
    }),
  ...
  destinationCityCode: z
    ...
    .max(3, { message: "Kode kota tujuan harus memiliki maximal 3 karakter" }),
});
