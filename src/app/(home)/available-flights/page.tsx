...
import LoadingFilterAirlines from "./components/loading-filter-airlines";
const FilterAirline = dynamic(() => import("./components/filter-airline"), {
  loading: () => <LoadingFilterAirlines />,
  ssr: false,
});
